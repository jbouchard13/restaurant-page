...
const data = {
  about: {
    ...
    text: "Spicy Ramen Shop is committed to delivering the highest quality ramen dishes around. By sourcing the best ingredients and by using timeless recipes from the Golden Age... Et velit minim id culpa. Sit amet non eu deserunt veniam nisi id mollit ad. Ex cillum occaecat officia aliqua. Ex do aliquip proident duis irure aliquip ipsum elit ullamco ea irure commodo culpa. Ea id ut elit ipsum aliqua nulla fugiat velit ullamco incididunt. Eiusmod esse et aliquip ex cillum. Commodo nostrud proident cillum eiusmod enim Lorem enim reprehenderit. Tempor reprehenderit culpa anim nostrud exercitation magna aliqua in officia quis culpa pariatur nulla. Laborum do in ea Lorem eiusmod anim sint.",
  },
  testimonials: [
    {
      name: "Zavala",
